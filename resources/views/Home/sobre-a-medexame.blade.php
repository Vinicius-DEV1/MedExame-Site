...
@section('content')
 ...
 <!DOCTYPE html>
    ...
    <body>
        <div class="container">
            <h1>Sobre a MedExame</h1>
            <p>A <span class="highlight">MedExame</span> é uma plataforma inovadora que conecta pacientes a diversos consultórios parceiros, oferecendo uma ampla variedade de consultas e exames médicos de forma acessível e prática.</p>
            ...
            <p>Escolha a <span class="highlight">MedExame</span> e tenha acesso a cuidados médicos de qualidade, com transparência, eficiência e a melhor experiência para o paciente.</p>
        </div>

        <div class="footer">
            <p>Entre em contato conosco: <a href="mailto:contato@medexame.com">contato@medexame.com</a></p>
        </div>
    </body>
    </html>
@endsection