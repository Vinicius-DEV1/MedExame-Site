...
@section('content')
    <div class="ms-5">
        ...
        <p><span style="color: rgb(68, 68, 68);">A sua privacidade é importante para nós. É política do Medexame respeitar a sua privacidade em relação a qualquer informação sua que possamos coletar no site <a href="">Medexame</a>, e outros sites que possuímos e operamos.</span></p>
        ...
        <p><span style="color: rgb(68, 68, 68);">O usuário se compromete a fazer uso adequado dos conteúdos e da informação que o Medexame oferece no site e com caráter enunciativo, mas não limitativo:</span></p>
        <ul>
            ...
            <li><span style="color: rgb(68, 68, 68);">C) Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do Medexame, de seus fornecedores ou terceiros, para introduzir ou disseminar vírus informáticos ou quaisquer outros sistemas de hardware ou software que sejam capazes de causar danos anteriormente mencionados.</span></li>
        </ul>
        ...
        <p><span style="color: rgb(68, 68, 68);">Esta política é efetiva a partir de&nbsp;25 January 2025 13:06</span></p>

        <h2><span style="color: rgb(68, 68, 68);">Termos de Serviço</span></h2>
        <p><span style="color: rgb(68, 68, 68);">Ao acessar ao site Medexame, concorda em cumprir estes termos de serviço, todas as leis e regulamentos aplicáveis ​​e concorda que é responsável pelo cumprimento de todas as leis locais aplicáveis. Se você não concordar com algum desses termos, está proibido de usar ou acessar este site. Os materiais contidos neste site são protegidos pelas leis de direitos autorais e marcas comerciais aplicáveis.</span></p>

        <h2><span style="color: rgb(68, 68, 68); font-size: 18px;">Uso de Licença</span></h2>
        <p><span style="color: rgb(68, 68, 68); font-size: 18px;">É concedida permissão para baixar temporariamente uma cópia dos materiais (informações ou software) no site Medexame, apenas para visualização transitória pessoal e não comercial. Esta é a concessão de uma licença, não uma transferência de título e, sob esta licença, você não pode:</span></p>
        <ol>
            <li><span style="color: rgb(68, 68, 68); font-size: 18px;">modificar ou copiar os materiais;</span></li>
            <li><span style="color: rgb(68, 68, 68); font-size: 18px;">usar os materiais para qualquer finalidade comercial ou para exibição pública (comercial ou não comercial);</span></li>
            <li><span style="color: rgb(68, 68, 68); font-size: 18px;">tentar descompilar ou fazer engenharia reversa de qualquer software contido no site Medexame;</span></li>
            <li><span style="color: rgb(68, 68, 68); font-size: 18px;">remover quaisquer direitos autorais ou outras notações de propriedade dos materiais;</span></li>
            <li><span style="color: rgb(68, 68, 68); font-size: 18px;">transferir os materiais para outra pessoa ou 'espelhe' os materiais em qualquer outro servidor.</span></li>
        </ol>
        <p><span style="color: rgb(68, 68, 68); font-size: 18px;">Esta licença será automaticamente rescindida se você violar alguma dessas restrições e poderá ser rescindida por Medexame a qualquer momento. Ao encerrar a visualização desses materiais ou após o término desta licença, você deve apagar todos os materiais baixados em sua posse, seja em formato eletrônico ou impresso.</span></p>

        <h2><span style="color: rgb(68, 68, 68); font-size: 18px;">Isenção de responsabilidade</span></h2>
        <ol>
            <li><span style="color: rgb(68, 68, 68); font-size: 18px;">Os materiais no site da Medexame são fornecidos 'como estão'. Medexame não oferece garantias, expressas ou implícitas, e, por este meio, isenta e nega todas as outras garantias, incluindo, sem limitação, garantias implícitas ou condições de comercialização, adequação a um fim específico ou não violação de propriedade intelectual ou outra violação de direitos.</span></li>
            <li><span style="color: rgb(68, 68, 68); font-size: 18px;">Além disso, o Medexame não garante ou faz qualquer representação relativa à precisão, aos resultados prováveis ou à confiabilidade do uso dos materiais em seu site ou de outra forma relacionado a esses materiais ou em sites vinculados a este site.</span></li>
        </ol>

        <h2><span style="color: rgb(68, 68, 68); font-size: 18px;">Limitações</span></h2>
        <p><span style="color: rgb(68, 68, 68); font-size: 18px;">Em nenhum caso o Medexame ou seus fornecedores serão responsáveis por quaisquer danos (incluindo, sem limitação, danos por perda de dados ou lucro ou devido a interrupção dos negócios) decorrentes do uso ou da incapacidade de usar os materiais em Medexame, mesmo que Medexame ou um representante autorizado da Medexame tenha sido notificado oralmente ou por escrito da possibilidade de tais danos. Como algumas jurisdições não permitem limitações em garantias implícitas, ou limitações de responsabilidade por danos consequentes ou incidentais, essas limitações podem não se aplicar a você.</span></p>

        <h2><span style="color: rgb(68, 68, 68); font-size: 18px;">Precisão dos materiais</span></h2>
        <p><span style="color: rgb(68, 68, 68); font-size: 18px;">Os materiais exibidos no site da Medexame podem incluir erros técnicos, tipográficos ou fotográficos. Medexame não garante que qualquer material em seu site seja preciso, completo ou atual. Medexame pode fazer alterações nos materiais contidos em seu site a qualquer momento, sem aviso prévio. No entanto, Medexame não se compromete a atualizar os materiais.</span></p>

        <h2><span style="color: rgb(68, 68, 68); font-size: 18px;">Links</span></h2>
        <p><span style="color: rgb(68, 68, 68); font-size: 18px;">O Medexame não analisou todos os sites vinculados ao seu site e não é responsável pelo conteúdo de nenhum site vinculado. A inclusão de qualquer link não implica endosso por Medexame do site. O uso de qualquer site vinculado é por conta e risco do usuário.</span></p>

        <h3><span style="color: rgb(68, 68, 68);">Modificações</span></h3>
        <p><span style="color: rgb(68, 68, 68);">O Medexame pode revisar estes termos de serviço do site a qualquer momento, sem aviso prévio. Ao usar este site, você concorda em ficar vinculado à versão atual desses termos de serviço.</span></p>

        <h3><span style="color: rgb(68, 68, 68);">Lei aplicável</span></h3>
        <p><span style="color: rgb(68, 68, 68);">Estes termos e condições são regidos e interpretados de acordo com as leis do Medexame e você se submete irrevogavelmente à jurisdição exclusiva dos tribunais naquele estado ou localidade.</span></p>
    </div>
@endsection